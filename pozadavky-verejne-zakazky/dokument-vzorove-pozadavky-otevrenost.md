...
# Vzorové požadavky na ICT zakázky - otevřenost řešení {#title}
...
-   Důvod předložení: dílčí cíl 2.8 Informační koncepce ČR a potřeba definovat sadu požadavků pro splnění zásad 16 a 17 IKČR a souvisejících architektonických principů
-   Poznámky: pracovní verze

## Úvod {#Úvod}

Vzorové požadavky na ICT zakázky - otevřenost řešení má za cíl připravit a dát k dispozici tu část vzorových požadavků na veřejné zakázky ICT, která se týká otevřenosti a zabránění závislosti na dodavateli. A umožnit tak zadavatelům plnit povinnosti otevřenosti řešení.. Materiál je určen pro veřejné zadavatele, orgány veřejné moci a subjekty připravující dokumentaci veřejných zakázek, důvodem zpracování a předložení je dílčí cíl 2.8 Informační koncepce ČR a potřeba definovat sadu požadavků pro splnění zásad 16 a 17 IKČR a souvisejících architektonických principů
...
Jako další kroky se navrhuje zadavatelům adoptovat příslušné požadavky do zadávací dokumentace pro veřejné zakázky k ICT a používat je pro každou zakázku na informační systém či ICT řešení.
...
## Vyjasnění potřeby požadavků a jejich použití {#vyjasněnípotřebypožadavkůajejichpoužití}

Informační koncepce České republiky, jež je pro veřejnou správu závazná, přináší mnoho povinností a pravidel, které stanovují rámec pro výstavbu a dodání informačních systémů určených právě pro samotnou veřejnou správu. IKČR Přináší kupříkladu povinnost využívání otevřeného software a otevřených standardů. Naproti tomu též pamatuje i na ty případy, kdy se otevřený software využít nedá a přesně stanovuje postup, který je nutné zvolit a který je závazný pro samotného zadavatele.
...
## Tři druhy požadavků k otevřeným řešením {#třidruhypožadavkůkotevřenýmřešením}
...
### Právní požadavky a požadavky na vztah k dodávce a dodavateli {#právnípožadavkyapožadavkynavztahkdodávceadodavateli}
...
Pro naplnění výše uvedeného je podstatné, aby byla již od počátku přesně stanovena zadávací dokumentace a veřejná zakázka na samotné dílo. Z toho také vychází povinnost obou smluvních stran o správném nastavení zastřešující smlouvy.
...
### Technické a funkční a nefunkční požadavky na technickou realizaci díla {#technickéafunkčníanefunkčnípožadavkynatechnickourealizacidíla}
...
### Znalostní požadavky a požadavky na dokumentaci a zdroje {#znalostnípožadavkyapožadavkynadokumentaciazdroje}
...
## Sada vzorových požadavků pro zadávací dokumentaci a požadavky na předmět u veřejných zakázekk otevřenosti {#subject}
...
V souvislosti s cílem připravit a dát k dispozici tu část vzorových požadavků na veřejné zakázky ICT, která se týká otevřenosti a zabránění závislosti na dodavateli. A umožnit tak zadavatelům plnit povinnosti otevřenosti řešení. se navrhují následující kroky:

1.  zadavatelům adoptovat příslušné požadavky do zadávací dokumentace pro veřejné zakázky k ICT a používat je pro každou zakázku na informační systém či ICT řešení

------------------------------------------------------------------------

pracovní verze

Praha, datum, Pracovní výbor pro architekturu a eGovernment Open-source Aliance a partneři
